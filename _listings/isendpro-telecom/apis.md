...
apis:
- name: API i Send Pro - Interrogation credit
  x-api-slug: credit-get
  ...
  tags: Agencies, Telecommunications, Messages, Profiles, Service API, Relative Data
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/credit/master/_listings/isendpro-telecom/credit-get-openapi.md
x-common:
- type: x-api-gallery
